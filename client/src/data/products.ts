...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: "Purchase, refinance, construction and bridge financing for owner-occupied and investment property.",
    heroSummary: "Financing for the building \u2014 buying it, refinancing it, building it, or bridging to the next stage.",
    whatItDoes: "Commercial mortgages fund the purchase or refinance of business premises and investment property, alongside construction advanced in stages and short-term bridge facilities. Terms depend on the property, its condition, whether you occupy it and what it earns.",
    useCases: ["Buying owner-occupied premises", "Refinancing to better terms or releasing equity", "Ground-up construction and major renovation", "Bridging to permanent financing or a sale"],
    term: "1\u201325 years depending on structure",
    typicalRange: "$250K\u2013$100M+",
    rateRange: "Varies by property type, occupancy and term",
    speed: "Longer \u2014 appraisals and environmental reports take time",
    collateral: "The property itself",
    bestUse: "Property",
    repayment: "Amortising, with construction advanced in stages",
    goodFit: [
      "You are buying or refinancing commercial property.",
      "You can wait weeks rather than days for the right structure.",
      "Owner-occupied premises \u2014 these generally price better than investment property.",
    ],
    relatedIndustries: ["Construction", "Retail", "Restaurant / Food Service", "Healthcare", "Manufacturing", "Distribution"],
  },
  {
    slug: "sba",
    name: "SBA Loans",
