...
export default function Products() {
  ...
  return <><SEO title="Business Financing Products | Term Loans, LOC, Equipment | Boreal Financial" description="Term loans, lines of credit, factoring, equipment finance, asset-based lending, sale and leaseback and SBA. One application reaches all of them." /><main className="bg-white font-sans text-boreal-ink">
