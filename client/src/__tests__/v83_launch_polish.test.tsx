...
describe("BF_WEBSITE_BLOCK_v83_LAUNCH_POLISH_v1", () => {
  it("Header 'Visit Boreal Insurance' link points to www.boreal.insure", () => {
    render(<Header />);
    const links = screen.getAllByRole("link", { name: /Visit Boreal Insurance/i });
  ...
  it("Footer Boreal Insurance link points to www.boreal.insure", () => {
    render(<Footer />);
    expect(screen.getByRole("link", { name: /Boreal Insurance/i }).getAttribute("href")).toBe("https://www.boreal.insure/");
  });
});
